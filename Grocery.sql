...
INSERT INTO room_master_table VALUES(42,'e87e4dde27a42c4d99e51dce1320ae18');
CREATE TABLE `category` (`category_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `name_fr` TEXT NOT NULL, `type` TEXT NOT NULL);
...
CREATE TABLE `product` (`product_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `list_id` INTEGER NOT NULL, `quantity` INTEGER NOT NULL, `purchased` INTEGER NOT NULL);
...
CREATE TABLE `groceryList` (`list_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `category_id` TEXT, `archived` INTEGER NOT NULL, `nb_products` INTEGER NOT NULL);
...
CREATE TABLE `productCategory` (`product_id` INTEGER NOT NULL, `category_id` INTEGER NOT NULL, PRIMARY KEY(`product_id`, `category_id`));
...
INSERT INTO sqlite_sequence VALUES('groceryList',31);
INSERT INTO sqlite_sequence VALUES('product',146);
COMMIT;
